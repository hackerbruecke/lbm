...
public:
  auto collision_model() const
  {
    return _collision_model;
  }

  auto input_file() const
  {
    return _input_file;
  }

  auto output_dir() const
  {
    return _output_dir;
  }

  auto output_filename() const
  {
  ...
  auto timesteps() const
  {
    return _timesteps;
  }

  auto timesteps_per_plot() const
  {
  ...
  auto omp_threads() const
  {
    return _omp_threads;
  }

  auto scenario_xml() const
  {
  ...
  Config(int argc, char** argv)
  {
    ...
    config.add_options()
      ...
      ("output-dir", po::value<std::string>(&_output_dir),
       "Output directory for plots");// End of options
