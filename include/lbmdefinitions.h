...
// Array types
template<size_t SIZE> using double_array  = std::array<double, SIZE>;
template<size_t SIZE> using int_array     = std::array<int, SIZE>;
template<size_t SIZE> using uint_array    = std::array<std::uint64_t, SIZE>;
